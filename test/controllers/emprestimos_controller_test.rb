...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference("Emprestimo.count") do
      post emprestimos_url, params: { emprestimo: { data_fim: @emprestimo.data_fim, data_inicio: @emprestimo.data_inicio, livro_id: @emprestimo.livro_id, pessoa_id: @emprestimo.pessoa_id, status: @emprestimo.status } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { data_fim: @emprestimo.data_fim, data_inicio: @emprestimo.data_inicio, livro_id: @emprestimo.livro_id, pessoa_id: @emprestimo.pessoa_id, status: @emprestimo.status } }
