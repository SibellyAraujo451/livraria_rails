...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { alugado: @livro.alugado, ano_publicacao: @livro.ano_publicacao, autor: @livro.autor, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { alugado: @livro.alugado, ano_publicacao: @livro.ano_publicacao, autor: @livro.autor, titulo: @livro.titulo } }
